...
def main():
	...
	for filename in inputList:
		...
		## Use the right separator and decimal for your data 
		...
		plt.plot(x1, y_pred1, color = "fuchsia", linestyle=':',linewidth=2) #orangered 
		plt.plot(x2, y_pred2, color = "fuchsia", linestyle=':',linewidth=2) #orangered 
